...
const Api = axios.create({
    baseURL: "https://flybuy-backend-cjn4.onrender.com",
...
//search products
export const searchProductsApi =(query) => Api.get(`/api/products/search/${query}`)//url ma janxa query

//count products
export const  countProductsApi = () =>Api.get("/api/products/get_count")

//forgot password
export const forgotPasswordApi = (data) => Api.post("/api/users/forgot_password",data)//data fnjmae, last,nmae
